...
room {
    ...
    decor = [[Я сперва не представлял, что это за супервайзеры такие и чего они "супервайзят", но потом понял.]];
...
room {
    ...
    decor = [[Внутрь склада можно попасть через здоровенный {вход|вход}, в который мог бы пролезть грузовик.^
        ...
        Сверху над входом, среди всего прочего, виден черный {провод|провод}, который свисает по стене с крыши
        и заходит внутрь склада через щель между железным косяком входа и стеной.
    ]];
    ...
    obj {
        nam = '#лестница';
        act = 'Ни к чему мне сейчас лезть на крышу, да и высоты я боюсь.';
    };
...
room {
    ...
    decor = [[Вдоль стены наверху расположена {проводка|проводка}. На складе есть много всего, требующего проводов:^
        камеры слежения,^ компьютер,^ телефон,^ электричество.^
