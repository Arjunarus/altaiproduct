    ...
    phr = {
        ...
        },
        {
            ...
            
            {
                ...
                'Ну, значит надо устранить!',
                {
                    'Ну это ж, наверное, на крышу надо лезть! Что я на крышу полезу?',
                    'А что ты сломаешься? Ну давай, я на крышу полезу!'
                },
                
                {
                    'А как на крышу залезть?',
                    'Ну я не знаю, спроси ключи от крыши у Жанны.'
                }
            },
            
            {
                'Хорошо я понял.',
                'Давай, сегодня надо исправить!'
            }
        }
    };
};
